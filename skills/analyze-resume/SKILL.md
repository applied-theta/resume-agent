---
description: Architecture reference and scoring context for the resume analysis pipeline
auto-loaded: true
---

# Resume Analysis Pipeline — Architecture Reference

This skill provides architecture context and scoring references for the resume analysis pipeline. It is auto-loaded to provide background knowledge to agents and commands.
...
User Layer:  Slash commands, conversational input, file-based input (workspace/input/)
    |
    v
Orchestration: /analyze-resume command - pipeline coordination
    |
    v
...
Support:     Scripts (extract-pdf-text, compute-scores, validate-output, md-to-pdf),
             Skills (ats-rules, content-quality, keyword-alignment, career-strategy, resume-writing)
    |
    v
